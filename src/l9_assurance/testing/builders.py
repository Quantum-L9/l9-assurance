...
def build_subject(overrides: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    output: dict[str, Any] = {"kind": "git-revision", **base, **deepcopy(dict(overrides))}
...
def build_observation(**overrides: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "producer": {
            "id": "l9-ci-sdk",
            "version": overrides.get("producer_version", "2.0.0"),
            "repository": "Quantum-L9/l9-ci-sdk",
        },
        "subject": deepcopy(overrides.get("subject", build_subject())),
        "check": {
            "id": check_id,
            "version": overrides.get("check_version", "1.0.0"),
            "configurationDigest": deepcopy(_ZERO_DIGEST),
        },
        "execution": {
            "runId": "run_fixture",
            "attempt": 1,
            "status": overrides.get("status", "passed"),
            "startedAt": overrides.get("started_at", "2026-07-21T00:00:00.000Z"),
            "completedAt": overrides.get("completed_at", "2026-07-21T00:00:01.000Z"),
        },
        "summary": {
