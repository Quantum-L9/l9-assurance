...
__all__ = ["AssuranceEngine", "CLI_COMMANDS", "describe_capabilities", "embedded_protocol_root", "load_configuration", "main", "parse_argv", "resolve_cli_command", "run_cli", "verify_plan"]
